...
public class StatementFactory {
	 ...
	 */
	public QueryStatement getCustomQuery(String baseStatement, RowEntry[] parameters) {
	 ...
	 */
	public QueryStatement getSelect(String table, Column[] columns, RowEntry[] criteria) {
	 ...
	 * @param parameters parameters to utilize in statement, will be substituted into the base statement in order of declaration
	 */
	public UpdateStatement getCustomUpdate(String baseStatement, RowEntry[] parameters) {
	 ...
	 */
	public UpdateStatement getCreateTable(String table, Column[] columns) {
	 ...
	 */
	public UpdateStatement getInsert(String table, RowEntry[] values) {
	 ...
	 */
	public UpdateStatement getDelete(String table, RowEntry[] criteria) {
	 ...
	 */
	public UpdateStatement getUpdate(String table, RowEntry[] values, RowEntry[] criteria) {
